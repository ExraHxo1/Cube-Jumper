...
COLOR_UNLOCKS = [
    ("Red",(255, 0, 0),0),
    ("Light Blue",(75, 157, 250),500),
    ("Dark Blue",(5, 0, 255),500),
    ("Light Green",(0, 200, 80),1000),
    ("Dark Green",(0, 92, 16),1500),
    ("White",(255, 255, 255),2000),
    ("Grey",(138, 138, 138),2500),
    ("Yellow",(255, 200, 0),3000),
    ("Orange",(255, 98, 0),3500),
    ("Gold",(212, 175, 55),4000),
    ("Purple",(170, 60, 255),4500),
    ("Pink",(255, 0, 122),5000),
    ("Brown",(87, 66, 0),5500),
    ("Black",(0, 0, 0,),6000),
]
